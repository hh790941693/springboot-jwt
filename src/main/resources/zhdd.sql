...
-- Dumping data for table zhdd.ws_ads: ~53 rows (approximately)
...
INSERT INTO `ws_ads` (`id`, `title`, `content`, `receive_list`, `create_time`) VALUES
	...
	(42, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:12'),
	(43, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:29'),
	(44, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:29'),
	(45, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:29'),
	(46, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:29'),
	(47, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:29'),
	(48, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:29'),
	(49, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:29'),
	(50, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:30'),
	(51, '交换机和韩国', '开机开卷考就', '[无名3]', '2020-05-11 20:12:30'),
...
-- Dumping data for table zhdd.ws_circle: ~27 rows (approximately)
...
INSERT INTO `ws_circle` (`id`, `user_name`, `user_id`, `content`, `like_num`, `pic1`, `pic2`, `pic3`, `pic4`, `pic5`, `pic6`, `create_time`) VALUES
	...
	(39, 'admin', 1, '刚发的时光时光归属感蔬果蔬果十多个十多个第三个十多个多个   多少广东省广东省大公司', 0, 'linux-back.png', 'player.jpg', '3.jpg', '微信图片_20181225175816.jpg', NULL, NULL, '2019-01-21 13:27:05'),
	(40, 'admin', 1, '今天天气好 人少', 0, NULL, '微信图片_20181225175816.jpg', NULL, NULL, NULL, NULL, '2019-01-21 13:36:55'),
	(41, 'aa', 23, '里面可能你究竟 ', 0, NULL, '2.jpg', NULL, NULL, NULL, NULL, '2019-01-26 21:57:31'),
	(42, '无名3', 13, '考虑时间管理会计师的价格快速', 0, 'http://localhost:8101/circle\\8.jpg', NULL, 'http://localhost:8101/circle\\8da770a589874189852b1504361231ae_th.gif', NULL, NULL, NULL, '2020-05-11 18:38:35');
...
CREATE TABLE IF NOT EXISTS `ws_file` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=536 DEFAULT CHARSET=utf8 COMMENT='文件表';

-- Dumping data for table zhdd.ws_file: ~32 rows (approximately)
...
-- Dumping data for table zhdd.ws_friends: ~12 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `ws_friends_apply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=149 DEFAULT CHARSET=utf8 COMMENT='好友申请表';
...
INSERT INTO `ws_friends_apply` (`id`, `from_id`, `from_name`, `to_id`, `to_name`, `process_status`, `create_time`) VALUES
	...
	(132, 31, 'dd', 24, 'bb', 1, '2020-05-13 18:11:22'),
...
INSERT INTO `ws_users` (`id`, `name`, `password`, `register_time`, `state`, `last_login_time`, `last_logout_time`, `enable`, `speak`, `question1`, `answer1`, `question2`, `answer2`, `question3`, `answer3`, `create_time`) VALUES
	(1, 'admin', 'MjQzMTBCNkQxNkM1NkZCNzk2M0ZCNEY1REMxQkM0NDk=', '2018-03-22 22:37:07', '1', '2020-05-16 09:05:34', '2020-05-16 09:05:31', '1', '1', '你最喜欢的明星是谁?', '11', '你最喜欢的一首歌是什么?', '22', '你父亲的生日是什么时候', '33', '2018-12-12 10:10:15'),
	...
	(23, 'aa', 'NDIzMUQzQ0UwODNEOUNGNTNEMTdDMEQzMkZDRTBFQ0E=', '2018-12-12 16:38:58', '0', '2020-05-15 22:52:45', '2020-05-15 22:44:15', '1', '1', '你最喜欢的水果是什么?', '带到', '你父亲生日是什么时候?', '带到', '你最想去哪旅行?', '的啊', '2018-12-12 16:38:58'),
	(24, 'bb', 'NDIzMUQzQ0UwODNEOUNGNTNEMTdDMEQzMkZDRTBFQ0E=', '2018-12-12 16:39:16', '0', '2020-05-15 21:06:14', '2020-05-15 22:52:12', '1', '1', '你最喜欢的水果是什么?', '的的', '你父亲生日是什么时候?', '都是大神', '你最想去哪旅行?', '都是的', '2018-12-12 16:39:16'),
	...
	(31, 'dd', 'NDIzMUQzQ0UwODNEOUNGNTNEMTdDMEQzMkZDRTBFQ0E=', '2020-05-13 13:35:41', '0', '2020-05-13 18:12:06', '2020-05-13 20:47:07', '1', '1', '你最喜欢的水果是什么?', '111', '你父亲生日是什么时候?', '111', '你最想去哪旅行?', '111', '2020-05-13 13:35:41');
...
INSERT INTO `ws_user_profile` (`id`, `user_id`, `user_name`, `real_name`, `img`, `sign`, `age`, `sex`, `sex_text`, `tel`, `address`, `profession`, `profession_text`, `hobby`, `hobby_text`, `create_time`) VALUES
	...
	(8, 1, 'admin', 'admin', 'http://localhost:8101/circle\\admin.jpg', '这人很懒,一点也没留下', 23, 1, '男', '8888888', '无名岛', 99, '其他', 99, '其他', '2019-01-16 11:00:50'),
	(9, 23, 'aa', '我没有名字', 'http://192.168.2.111:8101/headImg\\1.jpg', '不喜欢签名', 56, 1, '男', '13888888', '日本东京', 4, '个体商户', 4, '旅游', '2019-01-17 13:17:29'),
