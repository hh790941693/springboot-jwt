...
<html>
	...
	<body>
		<div id="uploadDiv" align="center" style="width:1070px;height:60px;margin:5px auto;border:2px solid green">
		...
		<div id="playerDiv" style="width:1070px;height:auto;border:3px solid green;margin:20px auto;">
			<div id="buttons" style="height:110px;">
				...
				<div style="height:75px;">
					<div style="float:left;width:310px;margin-top:5px">
						<audio id="player" controls="controls" src="" style="width:100%;"></audio>
					</div>

					<div style="float:right;border:1px solid bulue;margin-top:12px;width:750px;">
						<div style="float:left;margin-left:10px;height:40px;">
							...
							<button id="btnPlay" style='height:40px;' class='btn btn-success' onclick="play()">播&nbsp;&nbsp;&nbsp;&nbsp;放</button>
