  ...
  <script type="text/javascript">
    ...
    function createBalls() {
      for (var i = 0; i < 40; i++) {
        ...
        //随机小球起始的X坐标和小球的Y坐标
        ball.x = randomNum(40, 780);
        ball.y = randomNum(40, 540);
        //随机小球的移动速度
    ...
    function moveBalls(ballObj) {
      setInterval(function() {
        ...
        if (ballObj.yflag) {
          ...
          if (ballObj.y >= 580 - ballObj.offsetWidth) {
            ballObj.y = 580 - ballObj.offsetWidth;
            ballObj.yflag = false;
          }
        } else {
          //小球向上移动
        ...
        if (ballObj.xflag) {
          ...
          if (ballObj.x >= 820 - ballObj.offsetHeight) {
            ballObj.x = 820 - ballObj.offsetHeight;
            ballObj.xflag = false;
          }
        } else {
          //小球向左移动
