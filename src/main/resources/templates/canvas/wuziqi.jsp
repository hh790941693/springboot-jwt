...
<html>
	...
	<body>
		<div id="mainDiv" style="width:1100px;height:720px;margin:5px auto;overflow:hidden;border:2px solid green;">
            <canvas id="canvas" style="background-color:grey;margin:5px;float:left">
            </canvas>
            
            <div style="float:right;width:224px;height:696px;">
