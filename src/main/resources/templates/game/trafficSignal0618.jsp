...
<html>
	...
	<body>
		<div id="gameMainDiv" style="width:728px;height:554px;border:2px solid green;margin:1px auto;padding:10px;">
				<div id="borderDiv" style="width:720px;height:550px;margin:1px auto;">
					...
					if (i>=1 && i<=COL_MAX){
						...
						if (i%COL_MAX>=startCol+2 && i%COL_MAX<= endCol){
							...
							if (i%COL_MAX==startCol+2){
								$("#"+i).text("北");
								$("#"+i).css({"color":"blue","font-size":"21px","text-align":"center"});
							}
