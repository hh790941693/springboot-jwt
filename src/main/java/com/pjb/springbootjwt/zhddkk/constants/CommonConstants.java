...
public class CommonConstants 
{
	...
	public static final String WEBINF_IMGES = "/WEB-INF/static/images";
	
	//用户头像存储目录
	public static final String HEAD_IMAGES = WEBINF_IMGES + "/headimg";
	
	//朋友圈图片存储目录
	public static final String CIRCLE_IMAGES = WEBINF_IMGES + "/circleimg";
	...
	public static final String S_USER_AGENT = "user_agent"; //设备信息
