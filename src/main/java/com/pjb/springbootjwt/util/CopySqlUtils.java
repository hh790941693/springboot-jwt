...
public class CopySqlUtils {
    ...
    public static final String XXBF_BASE_PATH = "G:\\pj_mitubishi\\00_document\\04_詳細設計\\202107_変更対応\\現行本番\\20180426_mccmc\\";

    public static final String STORE_BASE_PATH = "C:\\Users\\huangchaohui\\Desktop\\三菱项目资料\\202107月三菱需求\\sql\\转换前\\mccmcKi\\";

    public static final String CC_SQL_PATH = "JavaSource\\jp\\co\\rsi\\mccmc\\cc\\integration\\dao\\impl\\sqlmap\\";

    public static final String COMMON_SQL_PATH = "JavaSource\\jp\\co\\rsi\\mccmc\\common\\dbauto\\integration\\dao\\impl\\sqlmap\\";

    public static final String MC_SQL_PATH = "JavaSource\\jp\\co\\rsi\\mccmc\\mc\\integration\\dao\\impl\\sqlmap\\";
    ...
    public static void run(){
        ...
        for (String cc : ccFileList) {
            if (cc.contains(":")) {
                ...
                copy(XXBF_BASE_PATH+CC_SQL_PATH+filename, STORE_BASE_PATH+CC_SQL_PATH+filename);
            } else {
                copy(TRUNK_BASE_PATH+CC_SQL_PATH+cc, STORE_BASE_PATH+CC_SQL_PATH+cc);
            }
        }
        ...
        for (String common : commonFileList) {
            if (common.contains(":")) {
                ...
                copy(XXBF_BASE_PATH+COMMON_SQL_PATH+filename, STORE_BASE_PATH+COMMON_SQL_PATH+filename);
            } else {
                copy(TRUNK_BASE_PATH+COMMON_SQL_PATH+common, STORE_BASE_PATH+COMMON_SQL_PATH+common);
            }
        }
        ...
        for (String mc : mcFileList) {
            if (mc.contains(":")) {
                ...
                copy(XXBF_BASE_PATH+MC_SQL_PATH+filename, STORE_BASE_PATH+MC_SQL_PATH+filename);
            } else {
                copy(TRUNK_BASE_PATH+MC_SQL_PATH+mc, STORE_BASE_PATH+MC_SQL_PATH+mc);
            }
        }
